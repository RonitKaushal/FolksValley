...
export default function dash_comp() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-8xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
